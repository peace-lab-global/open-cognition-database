...
> 本目录为佛教专题概念导航。**认知理论**（八识、心物一元、转识成智等）的权威版本位于 [`./cognitive-theory/`](cognitive-theory/README.md)；本目录下个别文件为历史遗留的早期版本，阅读时请以 cognitive-theory 版本为准。
...
完整认知理论体系入口：[`./cognitive-theory/README.md`](cognitive-theory/README.md)
